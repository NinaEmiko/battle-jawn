    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers(HttpMethod.POST, "/login", "/register", "/api/battle-session/create", "/api/battle-session/end", "/api/enemy", "/api/enemy-move", "/api/hero", "/api/hero-move", "/api/hero/rest/{id}", "/api/store/buy", "/api/store/sell", "/api/inventory/add/{id}").permitAll()
